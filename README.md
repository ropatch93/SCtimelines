...
<script>
  ...
  function load() {
    ...
    if (!milestones.length) {
      milestones = [
        { id: 1, title: 'Confirm venue', date: '', status: 'done', notes: '' },
        { id: 2, title: 'Send invitations', date: '', status: 'done', notes: '' },
        { id: 3, title: 'Catering order', date: '', status: 'in-progress', notes: 'Awaiting final headcount' },
        { id: 4, title: 'A/V setup', date: '', status: 'todo', notes: '' },
        { id: 5, title: 'Day-of run of show', date: '', status: 'at-risk', notes: 'Speaker slots still unconfirmed' },
      ];
      nextId = 6;
      save();
    }
